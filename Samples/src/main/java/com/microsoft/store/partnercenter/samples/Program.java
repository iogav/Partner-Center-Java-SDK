...
import com.microsoft.store.partnercenter.samples.analytics.GetPartnerLicenseDeploymentInsights;
import com.microsoft.store.partnercenter.samples.analytics.GetPartnerLicenseUsageInsights;
...
import com.microsoft.store.partnercenter.samples.customers.GetCustomerLicensesDeployment;
import com.microsoft.store.partnercenter.samples.customers.GetCustomerLicensesUsage;
...
public class Program {
	...
	public static void main(String[] args) {
		...
		mainScenarios.add(Program.getAnalyticsScenarios(context));
		// run the main scenario
		new AggregatePartnerScenario("Partner SDK samples", mainScenarios,
				context).run();
	}
	 ...
	 */
	private static IPartnerScenario getCustomerScenarios(
		...
		customerFilteringScenarios.add(new FilterCustomers(
				...
				context));
		customerFilteringScenarios.add(new FilterCustomers(
				"Filter by domain name", CustomerSearchField.DOMAIN_NAME,
				context));
		...
		customerScenarios.add(new GetPagedCustomers(context, Integer
				.parseInt(context.getConfiguration().getScenarioSettings()
						.get("CustomerPageSize"))));
		customerScenarios.add(new AggregatePartnerScenario(
				"Customer filtering", customerFilteringScenarios, context));
		customerScenarios.add(new GetCustomerDetails(context));
		customerScenarios.add(new GetCustomerQualification(context));
		customerScenarios.add(new GetCustomerLicensesDeployment(context));
		customerScenarios.add(new GetCustomerLicensesUsage(context));
		...
		return new AggregatePartnerScenario("Customer samples",
				customerScenarios, context);
	}
	...
	private static IPartnerScenario getOfferScenarios(IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Offer samples", offerScenarios,
				context);
	}
	...
	private static IPartnerScenario getOrderScenarios(IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Order samples", orderScenarios,
				context);
	}
	 ...
	 */
	private static IPartnerScenario getSubscriptionScenarios(
			IScenarioContext context) {
	 ...
	 * @return The subscription scenarios.
	 */
	private static IPartnerScenario getRatedUsageScenarios(
			IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Rated Usage samples",
				ratedUsageScenarios, context);
	}
	 ...
	 */
	private static IPartnerScenario getServiceRequestScenarios(
			IScenarioContext context) {
		...
		serviceRequestScenarios.add(new GetPagedPartnerServiceRequests(context,
				Integer.parseInt(context.getConfiguration()
						.getScenarioSettings().get("ServiceRequestPageSize"))));
		serviceRequestScenarios
				.add(new GetPartnerServiceRequestDetails(context));
		serviceRequestScenarios
				.add(new GetServiceRequestSupportTopics(context));
		serviceRequestScenarios.add(new UpdatePartnerServiceRequest(context));
		return new AggregatePartnerScenario("Service request samples",
				serviceRequestScenarios, context);
	}
	...
	private static IPartnerScenario getInvoiceScenarios(IScenarioContext context) {
		...
		invoiceScenarios.add(new GetInvoiceLineItems(context, Integer
				.parseInt(context.getConfiguration().getScenarioSettings()
						.get("InvoicePageSize"))));
		invoiceScenarios.add(new GetPagedInvoices(context, Integer
				.parseInt(context.getConfiguration().getScenarioSettings()
						.get("InvoicePageSize"))));
		return new AggregatePartnerScenario("Invoice samples",
				invoiceScenarios, context);
	}
	...
	private static IPartnerScenario getProfileScenarios(IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Partner Profile samples",
				profileScenarios, context);
	 ...
	 * @return The invoice scenarios.
	 */
	private static IPartnerScenario getCustomerUserScenarios(
			IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Customer User samples",
				customerUserScenarios, context);
	 ...
	 */
	private static IPartnerScenario getCustomerSubscribedSkusScenarios(
			IScenarioContext context) {
		List<IPartnerScenario> customerSubscribedSkusScenarios = new ArrayList<IPartnerScenario>();
		customerSubscribedSkusScenarios
				.add(new CustomerSubscribedSkus(context));
		return new AggregatePartnerScenario("Customer Subscribed Skus samples",
				customerSubscribedSkusScenarios, context);
	}
	 ...
	 */
	private static IPartnerScenario getCustomerDirectoryRoleScenarios(
			IScenarioContext context) {
		List<IPartnerScenario> customerDirectoryRoleScenarios = new ArrayList<IPartnerScenario>();
		customerDirectoryRoleScenarios.add(new GetCustomerDirectoryRoles(
				context));
		customerDirectoryRoleScenarios.add(new AddUserMemberToDirectoryRole(
				context));
		customerDirectoryRoleScenarios
				.add(new GetCustomerDirectoryRoleUserMembers(context));
		customerDirectoryRoleScenarios
				.add(new RemoveCustomerUserMemberFromDirectoryRole(context));

		return new AggregatePartnerScenario("Customer Directory Role samples",
				customerDirectoryRoleScenarios, context);
	}
	 ...
	 * @return The invoice scenarios.
	 */
	private static IPartnerScenario getAuditRecordScenarios(
			IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Auditing samples",
				auditRecordScenarios, context);
	 ...
	 */
	private static IPartnerScenario getRateCardScenarios(
			IScenarioContext context) {
		List<IPartnerScenario> rateCardScenarios = new ArrayList<IPartnerScenario>();
		rateCardScenarios.add(new GetAzureRateCard(context));

		return new AggregatePartnerScenario("Rate Card samples",
				rateCardScenarios, context);
	}
	 ...
	 */
	private static IPartnerScenario getIndirectPartnerScenarios(
			IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Indirect model samples",
				partnerScenarios, context);
	}
	 ...
	 * @return The invoice scenarios.
	 */
	private static IPartnerScenario getServiceIncidentScenarios(
			IScenarioContext context) {
		...
		return new AggregatePartnerScenario("Service Incident samples",
				serviceIncidentScenarios, context);

	}

	/**
	 * Gets the analytics scenarios.
	 *
	 * @param context
	 *            A scenario context.
	 * @return The analytics scenarios.
	 */
	private static IPartnerScenario getAnalyticsScenarios(
			IScenarioContext context) {
		List<IPartnerScenario> analyticsScenarios = new ArrayList<IPartnerScenario>();
		analyticsScenarios.add(new GetPartnerLicenseUsageInsights(context));
		analyticsScenarios
				.add(new GetPartnerLicenseDeploymentInsights(context));
		return new AggregatePartnerScenario("Partner Analytics samples",
				analyticsScenarios, context);
	}
