 ...
 */
public interface ICustomer extends IPartnerComponentString,
		IEntityGetOperations<Customer>, IEntityDeleteOperations<Customer> {
	/**
	...
	/***
	 * Obtains the analytics behavior for the customer.
	 */
