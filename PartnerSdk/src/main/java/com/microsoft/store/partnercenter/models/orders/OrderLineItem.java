...
public class OrderLineItem {
	...
	/**
	 * Gets or sets the parent subscription identifier. This parameter should
	 * only be set for add-on offer purchase Applies to Order updates only.
	 */
	...
	/**
	 * Gets or sets the order resulting contract information. This is out
	 * parameter only any input values to it will be ignored.
	 */
