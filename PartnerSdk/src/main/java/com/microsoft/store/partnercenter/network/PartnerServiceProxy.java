    ...
    implements IPartnerServiceProxy<TRequest, TResponse>
{
    ...
    {
        this.requestContext = RequestContextFactory.getInstance().create( this.requestContext.getCorrelationId(),
    ...
    {
        StringBuilder baseUri = new StringBuilder(PartnerService.getInstance().getApiRootUrl() + "/"
